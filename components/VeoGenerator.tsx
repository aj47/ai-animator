...
import { Download, ArrowLeft, Play, Move } from 'lucide-react';
...
const VeoGenerator: React.FC<VeoGeneratorProps> = ({ segment, originalVideoUrl, onBack }) => {
    ...
    <div className="w-full max-w-6xl mx-auto animate-in fade-in zoom-in-95 duration-300">
      ...
      <div className="flex flex-col items-center justify-center space-y-6">
          ...
          <div className="flex flex-col lg:flex-row gap-6 w-full justify-center items-start">
              ...
              {/* Generated Image */}
              <div className="flex flex-col gap-2 flex-1 w-full max-w-lg">
                   <span className="text-xs font-bold text-green-500 uppercase tracking-widest text-center lg:text-left">Green Screen Overlay</span>
                  ...
                  {/* Animation Guide Card */}
                  <div className="mt-2 p-3 rounded-lg bg-blue-900/10 border border-blue-900/30 flex items-start gap-3">
                    <div className="p-1.5 bg-blue-500/20 rounded-md shrink-0">
                        <Move className="w-4 h-4 text-blue-400" />
                    </div>
                    <div>
                        <h4 className="text-xs font-bold text-blue-300 uppercase tracking-wider mb-0.5">Suggested Animation</h4>
